...
public class ConvertToStreamExample {
    public static void main(String[] args) {
        ...
        // ConvertToStreamExample.streamUsingGenerate();
   ...
   public static void streamUsingGenerate() {
       Stream<String> stream = Stream.generate(() -> "devcamp").limit(3);
       String[] testStrArr = stream.toArray(String[]::new);
       System.out.println(Arrays.toString(testStrArr)); // [devcamp, devcamp, devcamp]
   }
   ...
   public static void streamUsingRegex() {
       String str = "Welcome,to,devcamp";
       Pattern.compile(",").splitAsStream(str).forEach(System.out::print);// Welcometodevcamp
   }
}
