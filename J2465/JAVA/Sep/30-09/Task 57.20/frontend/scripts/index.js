...
async function onPageLoading() {
  ...
  const menuData = await fetchData("http://localhost:8080/combomenu");
  displayMenu(menuData);
}

function displayMenu(menuData) {
  const combosElement = document.getElementById("size-combos");
  ...
  menuData.forEach((menu) => {
    html += `                
      <div class="col-sm-4 pizza-size">
        <div class="card">
          <div
            class="card-header bg-main-brand text-white text-center"
          >
            <h3>${
              menu.size === "S"
                ? "S (Small size)"
          ...
          <div class="card-body text-center">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">Sườn nướng <b>${menu.suon}</b></li>
              <li class="list-group-item">Salad <b> ${menu.salad} gr</b></li>
              <li class="list-group-item">Nước ngọt <b>${
                menu.soLuongNuocNgot
              }</b></li>
              <li class="list-group-item">
                <h1>VND <b>${formatter.format(menu.donGia)}</b></h1>
              </li>
            </ul>
          </div>
