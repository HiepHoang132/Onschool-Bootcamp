...
function runGraphAlgorithms() {
  ...
  document.getElementById("dijkstra").innerText = JSON.stringify(
    dijkstra(graph, vertices, 0)
  );
  document.getElementById("bellmanFord").innerText = JSON.stringify(
    bellmanFord(graph, vertices, 0)
  );
  document.getElementById("floydWarshall").innerText = JSON.stringify(
    floydWarshall(graph, vertices)
  );
  document.getElementById("prim").innerText = JSON.stringify(
    prim(graph, vertices)
  );
  document.getElementById("kruskal").innerText = JSON.stringify(
